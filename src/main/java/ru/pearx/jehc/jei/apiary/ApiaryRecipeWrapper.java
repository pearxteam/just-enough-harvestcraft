...
public class ApiaryRecipeWrapper extends BlankRecipeWrapper
{
    ...
    {
        String s = percents + "%";
        int w = minecraft.fontRendererObj.getStringWidth(s);
        minecraft.fontRendererObj.drawString(s, 6 + ((50 - w) / 2), 48 + ((11 - minecraft.fontRendererObj.FONT_HEIGHT) / 2), Color.BLACK.getRGB());
    }
}
